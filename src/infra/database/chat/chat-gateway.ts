...
export class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
    ...
    async handleJoinRoom(client: Socket, roomName: string) {
        ...
        await this.chatRepository.createRoom(roomName)
    ...
    handleNewMessage(client: Socket, @MessageBody() message: { roomName: string, content: string }) {
        ...
        this.chatRepository.sendMessage(content, roomName, id)
    }
}